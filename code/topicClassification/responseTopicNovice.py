...
def getData(fpInputYear,fpOutputYear):
    ...
    # filtered = my_csv.Score.str.match("N-",na=False)
    # my_csv3 = my_csv2[my_csv2.Score != "N-UR"]
    ...
    dictTopicResponse = {}
    dictTopicString = {}     # indexItemLabel=0
    ...
    for item in columnResponse:
        ...
        if not (strScore.startswith('N-') and strScore != 'N-UR'):
            continue
        ...
        #     # dictScoreResponse['N-MF'].append(' ')
        #     # dictScoreResponse['N-MF'].append(strPOS)
        # elif strScore == strMM:
        #     dictScoreResponse[strMM].append(strResponse)
        #     # dictScoreResponse['N-MM'].append(' ')
        #     # dictScoreResponse['N-MM'].append(strPOS)
        # elif strScore == strSE:
        #     dictScoreResponse[strSE].append(strResponse)
        #     # dictScoreResponse['N-SE'].append(' ')
        #     # dictScoreResponse['N-SE'].append(strPOS)
        # elif strScore == strNE:
        #     dictScoreResponse[strNE].append(strResponse)
        #     # dictScoreResponse['N-NE'].append(' ')
        #     # dictScoreResponse['N-NE'].append(strPOS)
...
def main():
    ...
    fpOutputCombine = 'vector_novice_combine.csv'
