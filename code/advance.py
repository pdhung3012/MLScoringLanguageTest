...
# set file directory
fpInput='/home/hung/git/confres/eti/code/step3/rtNew2019TrainTest/advance/'
...
all_data = df_all.drop(['no','testId','topic','expected','predicted','maxSim','binary'],axis=1)

df_test = pd.read_csv(fpInput+fn2019)
test_label = df_test['expected']
# all_data = df_all.drop(['label','maxSim','maxSim-r2','maxSim-r3','maxSim-r4','maxSim-p1','maxSim-p2','maxSim-p3','maxSim-p4'],axis=1)
test_data = df_test.drop(['no','testId','topic','expected','predicted','maxSim','binary'],axis=1)
