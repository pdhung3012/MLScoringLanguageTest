...
# set file directory
fpInput='/home/hung/git/confres/eti/code/step3/novice/'

# load data for 10-fold cv
df_all = pd.read_csv(fpInput+'novice_outRes4gram_2018.csv')
...
df_test = pd.read_csv(fpInput+'novice_outRes4gram_2019.csv')
