...
# set file directory
fpInput='/home/hung/git/confres/eti/code/step3/rtNew2019TrainTest/topicIntermediate_v2/'
fn2018='train.csv'
fn2019='test.csv'
# load data for 10-fold cv
df_all = pd.read_csv(fpInput+fn2018)
print(list(df_all.columns.values))
all_label = df_all['topic']
# all_data = df_all.drop(['label','maxSim','maxSim-r2','maxSim-r3','maxSim-r4','maxSim-p1','maxSim-p2','maxSim-p3','maxSim-p4'],axis=1)
all_data = df_all.drop(['no','testId','topic','username'],axis=1)

df_test = pd.read_csv(fpInput+fn2019)
test_label = df_test['topic']
# all_data = df_all.drop(['label','maxSim','maxSim-r2','maxSim-r3','maxSim-r4','maxSim-p1','maxSim-p2','maxSim-p3','maxSim-p4'],axis=1)
test_data = df_test.drop(['no','testId','topic','username'],axis=1)
