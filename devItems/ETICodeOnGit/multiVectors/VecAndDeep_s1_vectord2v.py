...
def main():
    folder = "../../../../resultETI/d2vAndDeep/"
    folderVector=folder+'vector/'
    folderModelD2v = folder + 'modelD2v/'
    createDir(folder)
    createDir(folderVector)
    createDir(folderModelD2v)

    fpInput = 'all-formA.csv'
    fpOutputIntermediate = folderVector+'AI_d2v_vector.csv'
    fpOutputNovice = folderVector+'AN_d2v_vector.csv'
    fpOutputNoviceD2v = folderModelD2v + 'AN_10cv.d2v.txt'
    fpOutputIntermediateD2v = folderModelD2v + 'AI_10cv.d2v.txt'

    fpFormBInput = 'all-formB.csv'
    fpOutputFormBIntermediate = folderVector+'BI_d2v_vector.csv'
    fpOutputFormBAdvance = folderVector+'BA_d2v_vector.csv'
    fpOutputFormBIntermediateD2v = folderModelD2v + 'BI_10cv.d2v.txt'
    fpOutputFormBAdvanceD2v = folderModelD2v + 'BA_10cv.d2v.txt'
