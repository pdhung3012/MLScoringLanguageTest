...
def main():
    ...
    # fpOutputYear2018 = 'vector_advance_pos_ratingPositionFilter_2018.csv'
    # fpInputYear2019 = 'ratingPositionFilter_2019.csv'
    # fpOutputYear2019 = 'vector_advance_pos_ratingPositionFilter_2019.csv'
    ...
    fpOutputYearNewData2019 = 'vector_advance_pos_ratingPositionFilter_newData_2019.csv'
    # getData(fpInputYear2018,fpOutputYear2018)
    # getData(fpInputYear2019, fpOutputYear2019)
