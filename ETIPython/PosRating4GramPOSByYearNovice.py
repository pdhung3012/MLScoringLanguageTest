...
def getData(fpInputYear,fpOutputYear):
    ...
    for item in columnPOS:
        ...
        strResponse = str(columnPOS[i]).replace("<p>", "").replace("</p>", "").replace("<br>", "")
        # print(strResponse)
...
def main():
    ...
    fpOutputYear2018 = 'vector_novice_pos_ratingPositionFilter_2018.csv'
    fpInputYear2019 = 'ratingPositionFilter_2019.csv'
    fpOutputYear2019 = 'vector_novice_pos_ratingPositionFilter_2019.csv'
    fpInputYearNewData2019 = 'ratingPositionFilter_newData_2019.csv'
    fpOutputYearNewData2019 = 'vector_novice_pos_ratingPositionFilter_newData_2019.csv'
