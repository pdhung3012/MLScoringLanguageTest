...
novice = agreed[agreed['Score'].str.startswith("A") == True]  # ** why some nan in 'score' column
...
data = data[data.Score != 'A-UR']
data['Score'].value_counts()  # shortage of 'I-NE' cases
data.to_csv('advance_2018.csv')
