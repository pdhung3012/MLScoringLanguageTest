...
def getPOSFromResponse(string,spanish_postagger):
...
def main():
    ...
    # stanfordPOSTagger
    spanish_postagger = st.StanfordPOSTagger('stanfordPOSTagger/models/spanish.tagger', 'stanfordPOSTagger/stanford-postagger.jar', encoding='utf8')
    ...
    for i in range(len(columnResponse)):
        ...
        strResponse =getPOSFromResponse(strResponse,spanish_postagger)
        print(str(i)+"\t"+strResponse)
    ...
    csv = open('output_POS4Gram_2018.csv', 'w')
