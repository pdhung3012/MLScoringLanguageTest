...
# set file directory
fpInput='/home/hung/git/confres/eti/code/step3/advance/'

# load data for 10-fold cv
df_all = pd.read_csv(fpInput+'advance_outRes4gram_2018.csv')
...
df_test = pd.read_csv(fpInput+'advance_outRes4gram_2019.csv')
